...
namespace WebStore.Services.Data
{
    public static class TestData
    {
        ...
        {
            new Employee {  LastName = "Иванов", Name = "Иван", Patronymic = "Иванович", Age = 27, Info = "Первый сотрудник" },
            new Employee { LastName = "Петров", Name = "Пётр", Patronymic = "Петрович", Age = 31, Info = "Второй сотрудник" },
            new Employee {  LastName = "Сидоров", Name = "Сидор", Patronymic = "Сидорович", Age = 18, Info = "Третий сотрудник" },
        };
